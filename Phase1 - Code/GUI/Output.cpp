...
void Output::CreateDrawToolBar() const
{
	...
	MenuItemImages[ITM_Zoom] = "images\\MenuItems\\Menu_Zoom.jpg";
	...
	for (int i = 0; i < DRAW_ITM_COUNT; i++)
		pWind->DrawImage(MenuItemImages[i], i * 80, 0, 80, UI.ToolBarHeight);
...
void Output::CreatePlayToolBar() const
{
	...
	string MenuPlayImages[PLAY_ITM_COUNT];
	MenuPlayImages[ITM_Pick] = "images\\MenuItems\\Menu_Pick.jpg";
	MenuPlayImages[ITM_Find] = "images\\MenuItems\\Menu_Find.jpg";
	MenuPlayImages[ITM_Draw] = "images\\MenuItems\\Menu_Draw.jpg";
	MenuPlayImages[ITM_EXIT2] = "images\\MenuItems\\Menu_Exit.jpg";
	pWind->DrawRectangle(0, 0, 1550, 50);
	for (int i = 0; i < PLAY_ITM_COUNT; i++)
		pWind->DrawImage(MenuPlayImages[i], i * 100, 0, 100, UI.ToolBarHeight);
